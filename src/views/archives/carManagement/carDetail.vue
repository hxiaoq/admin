...
import carDetail from '@/api/archives/carManagement/carDetail.js'
...
//运维公司下拉数
    ...
    modalClose() {
     ...
     //导出
    exportt(data) {
       window.location.href=process.env.VUE_APP_BASE_API+"api-obdMonitor/carDetails/getCarDetailsExport?access_token="+this.token+"&companyName="+this.tableQuery.companyName+"&orgId="+this.tableQuery.orgId+"&dischargeStandard="+this.tableQuery.dischargeStandard+"&obdStatus="+this.tableQuery.obdStatus+"&plateNo="+this.tableQuery.plateNo+"&vehicleStatus="+this.tableQuery.vehicleStatus
