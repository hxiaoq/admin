...
import carArchivesInfo  from "@/api/archivesSoHo/carArchivesInfo.js";
  ...
  methods: {
    ...
    goJCSJ(type){
      var params={
       ...
       this.$router.push({
            path: "/dynamicMonitorSoHo/historyDataDetail",
            query:params,
          });
    },
    //跳转预警详情
    ...
    //跳转历史记录
      goHistory(data) {
      this.$router.push({
        path: '/dynamicMonitorSoHo/historyData',
