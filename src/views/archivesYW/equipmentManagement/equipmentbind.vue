...
import equipmentbind from "@/api/archivesYW/equipmentManagement/equipmentbind.js";
...
export default {
  ...
  methods: {
    ...
    //导出
    exportt(){
      window.location.href=process.env.VUE_APP_BASE_API+"api-obdMonitor/companyDetailsOper/getDeviceDetailsExport?access_token="+this.token+"&code="+this.tableQuery.code+"&plateNo="+this.tableQuery.plateNo;
