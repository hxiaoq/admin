  ...
  methods: {
    ...
    async getEarlyWarningTimesPageByCar(limit, page) {
      ...
      await analysis
       ...
       //导出
    exportt(data) {
       window.location.href=process.env.VUE_APP_BASE_API+"api-obdMonitor/carEarlyWarningCount/getEarlyWarningTimesByCar?access_token="+this.token+
