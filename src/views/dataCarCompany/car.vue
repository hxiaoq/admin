  ...
  methods: {
    ...
    async getEarlyWarningTimesPageByCar(limit, page) {
      ...
      await analysis
       ...
       //导出
    exportt(data) {
       window.location.href=process.env.VUE_APP_BASE_API+"api-obdMonitor/carEarlyWarningCountEnt/getEarlyWarningTimesByCar?access_token="+this.token+
    ...
    goDetail(data) {
      this.$router.push({
        path: '/warnCarCompany/warnDetails',
