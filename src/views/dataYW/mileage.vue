  ...
  <div>
    ...
    <el-row :gutter="20">
      ...
      >
        ...
        <el-table-column prop="plateNo" label="车牌号" width="120" show-overflow-tooltip />
...
export default {
  ...
  methods: {
    ...
    initChart2(data, yAxis) {
     ...
     //导出
    exportt(data) {
       window.location.href=process.env.VUE_APP_BASE_API+"api-obdMonitor/roadHualAnalysisOper/getRoadHualListExport?access_token="+this.token+
       "&orgId="+this.formInline.orgId+
       "&startDate="+this.formInline.time[0]+
       "&endDate="+this.formInline.time[1]
