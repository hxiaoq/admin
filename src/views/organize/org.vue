<template>
  <div>
    ...
    <el-table
      ...
      row-key="orgId"
      border
      :tree-props="{ children: 'childOrgs', hasChildren: 'hasChildren' }"
    >
      <el-table-column label="序号" width="80" type="index"> </el-table-column>
      <el-table-column prop="orgName" label="机构名称"> </el-table-column>
      <el-table-column prop="orgCode" label="机构编码" width="180">
      </el-table-column>
      <el-table-column prop="orgType" width="180" label="类型">
      </el-table-column>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="机构类型" prop="orgType" required>
              ...
              >
                <el-option
                  v-for="val in orgTypeArryTemp"
                  :key="val.orgTypeId"
                  :value="val.orgTypeId"
                  :label="val.orgTypeName"
                />
              </el-select>
            </el-form-item>
          </el-col>
...
export default {
  ...
  methods: {
    getData(name, orgId) {
      // if (this.inputText != "") {
      org
        .getTableListByOrgName({ orgName: name, orgId: orgId })
        .then((response) => {
    ...
    onBM(data) {
      this.$router.push({
        path: "/organize/departmentDetail",
