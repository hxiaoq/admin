      ...
      <el-col :span="15" v-show="isShow">
        <div v-show="isOrg">
          ...
          <div style="margin-top: 20px; text-align: right">
            <el-button type="primary" size="small" @click="saveTable()"
              >保存</el-button
            >
...
//import tablePage from "@/utils/tablePage.js";
export default {
  components: {
    TreeSelect,
  },
  ...
  mounted() {
    ...
    this.tableHeight = Math.floor(
      document.documentElement.clientHeight -
        this.$refs.multipleTable.$el.getBoundingClientRect().top -
        280
    );
    this.treeHeight = this.tableHeight + "px";
  ...
  filters: {
    ...
    downLoad(row) {
      return (
        process.env.VUE_APP_BASE_API + "/files/files/downLoad?id=" + row.userId
      );
    },
  },
  watch: {
