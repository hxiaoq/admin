<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="id" min-width="200" label="文件ID" sortable>
      </el-table-column>
      <el-table-column
        prop="name"
      ...
      <el-table-column prop="suffix" min-width="110" label="文件后缀" sortable>
      </el-table-column>
      <el-table-column prop="size" min-width="130" label="文件大小(B)" sortable>
      </el-table-column>
      <el-table-column prop="clientName" min-width="120" label="所属应用" sortable>
      </el-table-column>
      <el-table-column prop="fileShow" min-width="120" label="文件展示" sortable>
        <template slot-scope="scope">
      ...
      <el-table-column prop="time" min-width="160" label="上传时间" sortable>
      </el-table-column>

      <el-table-column label="操作"  min-width="160" fixed="right" header-align="left" align="right">
        <template slot-scope="scope">
...
export default {
  ...
  mounted() {
     this.tableQuery.limit = Math.floor(
      (document.documentElement.clientHeight - this.$refs.tableDiv.$el.getBoundingClientRect().top - 93) /42
    );
    this.getTableList();
    // this.getImage()
  },
