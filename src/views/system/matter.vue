<template>
  ...
  <div>
    ...
    >
      ...
      <el-table-column prop="defaultUnit" min-width="120" label="缺省单位" sortable>
      </el-table-column>
      <el-table-column prop="disUnit" min-width="120" label="浓度单位" sortable>
      </el-table-column>
      <el-table-column
